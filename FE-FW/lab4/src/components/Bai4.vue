<template>
  <div class="container mt-4">
    <h2 v-if="!isEditing">Thêm sách mới vào thư viện</h2>
    <h2 v-else>Cap nhat sach</h2>
    <form @submit.prevent="isEditing ? updateBook() : addBook()">
      <div class="mb-3">
        ...
        <input
          type="text"
          :value="bookTitle"
          @input="bookTitle = $event.target.value"
          class="form-control"
          id="bookTitle"
      ...
      <div class="mb-3">
        ...
        <input
          type="text"
          :value="bookAuthor"
          @input="bookAuthor = $event.target.value"
          class="form-control"
          id="bookAuthor"
      ...
      <div class="mb-3">
        ...
        <select
          :value="bookCategory"
          @change="bookCategory = $event.target.value"
          class="form-select"
          id="bookCategory"
        >
      ...
      <div class="mb-3">
        ...
        <input
          type="number"
          :value="bookQuantity"
          @input="bookQuantity = $event.target.value"
          class="form-control"
          id="bookQuantity"
          placeholder="Nhập số lượng"
          @keyup.enter.prevent="addBook"
        />
      </div>

...
heartIcons.forEach(function (heartIcon, index) {
  heartIcon.onclick = function () {
    ...
    const mobileTabletHeartItemQuantity = windowParent.querySelector(
      ".mobile-tablet-heart-item-quantity"
    );
...
cartIcons.forEach(function (cartIcon, index) {
  cartIcon.onclick = function () {
    ...
    const mobileTabletCartItemQuantity = windowParent.querySelector(
      ".mobile-tablet-cart-item-quantity"
    );

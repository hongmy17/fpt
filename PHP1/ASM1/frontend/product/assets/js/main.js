...
const headerContainerOptionLinks = $$(".container-option__link");
...
headerContainerOptionLinks.forEach((optionLink) => {
  optionLink.onclick = function () {
    const optionLinkActive = $(".container-option__link.active");
    optionLinkActive?.classList.remove("active");
    this.classList.add("active");
  };
});
// end content

<?php 
  ...
  $query_products = "SELECT p.pd_img, p.pd_name, o.quantity, o.price FROM order_detail o 
    JOIN products p ON o.pd_id  = p.pd_id WHERE o.order_id = '$order_id'";

          ...
          <div class="wrapper">
            <table class="custom-table">
              <thead>
                <tr class="row header-table">
                  <th class="col l-6 m-6 c-12">
                    <h1 class="title">Quản lý hoa don</h1>
                  </th>
                ...
                <tr class="row">
                  ...
                  <th class="col l-6 m-5 c-0 name-column">Địa chỉ</th>
              ...
              <tbody>
                <?php
                  ...
                  $query = "SELECT b.bill_id, b.shipping_address, b.total, us.us_name 
                    FROM bills b JOIN users us ON b.us_id = us.us_id";
                      ...
                      <tr class='row'>
                        ...
                        <td class='col l-1 m-2 c-2 name-column'>
                          <span class='info-icon-container' style='margin-left: 20px'>
                            <i class='fa-solid fa-info info-icon action-icon' bill-id='$id'></i>
                          </span>
                        </td>
                      </tr>";
                    $order_number++;
            ...
            <table class="custom-table table-detail">
              <thead>
                ...
                <tr class="row">
                  <th class="col l-1 m-1 c-2 name-column">STT</th>
                  <th class="col l-1 m-2 c-5 name-column">Ảnh</th>
                  <th class="col l-2 m-3 c-5 name-column">Tên</th>
                  <th class="col l-1 m-1 c-5 name-column">SL</th>
                  <th class="col l-2 m-2 c-0 name-column">Giá</th>
                  <th class="col l-2 m-3 c-0 name-column">Tổng</th>
                  <th class="col l-3 m-3 c-0 name-column">Ngay DH</th>
                </tr>
              </thead>
              <tbody></tbody>
            </table>

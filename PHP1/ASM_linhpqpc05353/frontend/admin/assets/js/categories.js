...
$('.category-link[href*="categories.php"]').classList.add("active");
...
headerDeleteAction.onclick = (e) => {
  if (e.target.matches(".active")) {
    ...
    validate("delete-category", arrId);
  }
};
...
function handleAction(action) {
  modalForm.setAttribute("action", `${baseUrl}/${action}.php`);
  modalForm.submit();
}

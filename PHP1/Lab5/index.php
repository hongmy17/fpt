      ...
      <table class="custom-table">
        ...
        <tbody>
          <?php
            ...
            $query = "SELECT us_name, us_email, us_phone, is_admin FROM users";
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              echo "
                <tr class='row'>
                  ...
                  <td class='col l-1 m-1 c-1 name-column'>$id</td>
            ...
            $query = "SELECT us_id AS last_id FROM users ORDER BY us_id DESC LIMIT 1";
            $result = mysqli_query($dbc, $query) or die('Error querying database');
            $last_id = mysqli_fetch_array($result)['last_id'];
            echo "<input type='text' hidden name='last-id' value='$last_id' />";

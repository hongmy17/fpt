...
<div class="container rounded" style="padding: 50px 0;">
  <div class="bg-white">
    <form action="{{ route('admin.user.update', ['id' => $user->id]) }}" method="post" class="row align-items-center edit-form" enctype="multipart/form-data">
      @csrf
...
<script src="{{ asset("features/Validator.js") }}"></script>
<script src="{{ asset("features/loadImageFromInput.js") }}"></script>

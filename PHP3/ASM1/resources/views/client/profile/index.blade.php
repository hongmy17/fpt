...
<div class="container rounded" style="padding-top: 50px; padding-bottom: 50px">
  <div class="bg-white">
    <form action="" method="post" class="row align-items-center account-form" enctype="multipart/form-data">
          ...
          <div class="row mt-2">
            <div class="col-md-12">
              ...
              <input
                ...
                value="linhpqpc05353@fpt.edu.vn"
                name="email"
              />
              <p class="field-message mb-0"></p>
            </div>
...
<!-- Validatejs 0.13.1 -->
<script src="/validatejs/validate.min.js"></script>
